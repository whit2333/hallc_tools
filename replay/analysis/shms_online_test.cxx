...
/** 
 */
void shms_online_test(Int_t RunNumber = 0, Int_t MaxEvent = 0) {
...

  {
    ...
    ofstream   monitor_output(monitor_dir+"/hists.jsons");
    
    if( auto phgcer_tot_npe = (TH1F*)gROOT->FindObject("phgcer_tot_npe") ){
      monitor_output  << TBufferJSON::ToJSON(phgcer_tot_npe);
    }
